...
ruta_indices = r"C:\Users\ASUS\OneDrive - UNIVERSIDAD DE INGENIERIA Y TECNOLOGIA\Escritorio\bd2_proyecto_2023.2\proyecto_2\Project2_db2\InvertedIndex\Final_Index"
...
def write_index(nro_index:int, index:dict)->None:
    ...
    write_json("index"+nro_index_str+".json", index) #escribimos el diccionario en un archivo json
